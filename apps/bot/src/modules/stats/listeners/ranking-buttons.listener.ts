...
async function handleRankingButton (
	interaction: ButtonInteraction,
	rankingType: string
): Promise<void> {
	try {
		...
		const embed = await buildRankingEmbed(interaction, rankingType)
